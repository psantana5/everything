...
class DuplicateFinderUI(QMainWindow):
    ...
    def scan_directory(self):
        ...
        directory = dialog.getExistingDirectory(self, "Select Directory")
        ...
        if directory:
            ...
            self.worker = DuplicateFinderWorker(
                directory, extensions, delete_duplicates, move_duplicates)
            ...
            self.worker.current_directory.connect(
